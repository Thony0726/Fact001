            ...
            switch (item.getItemId()) {
                ...
                case R.id.item2:
                    ...
                    bottomsheetView.findViewById(R.id.btn_param_cliente).setOnClickListener(v -> {
                        startActivity(new Intent(MainActivity.this, ActivityClientes.class));
                        finish();
...
//                        getSupportFragmentManager().beginTransaction().replace(R.id.fragment_layout, new fragment_Empleados()).commit();
                        startActivity(new Intent(MainActivity.this, ActivityEmpleados.class));
                        finish();
...
//                        getSupportFragmentManager().beginTransaction().replace(R.id.fragment_layout, new fragment_Proveedores()).commit();
                        startActivity(new Intent(MainActivity.this, ActivityProveedores.class));
                        finish();
...
//                        getSupportFragmentManager().beginTransaction().replace(R.id.fragment_layout, new fragment_Productos()).commit();
                        startActivity(new Intent(MainActivity.this, ActivityProductos.class));
                        finish();
                    ...
                    break;
                case R.id.item3:
                    startActivity(new Intent(MainActivity.this, ActivityInventario.class));
                    finish();
                    Toast.makeText(MainActivity.this, "inventario", Toast.LENGTH_SHORT).show();
                    break;
                case R.id.item4:
                    startActivity(new Intent(MainActivity.this, ActivityFacturacion.class));
                    finish();
